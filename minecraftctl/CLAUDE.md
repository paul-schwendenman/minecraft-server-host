...
| `map` | `cmd/minecraftctl/map.go` | build, preview, manifest, index, config, backup, update |
...
- `map update status|start|stop|enable|disable|logs <world>` - Control `minecraft-map-update@<world>`
